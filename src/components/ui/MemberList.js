...
class MemberList extends Component {
    ...
    componentDidMount(){
        //as soon as render method fires for the frist time
        this.setState({loading:true})
        fetch('https://api.randomuser.me/?nat=US&results=12')
            .then(response => response.json()) //creates json out of resp
            .then(json => json.results) //looks for the "results" key in resp
